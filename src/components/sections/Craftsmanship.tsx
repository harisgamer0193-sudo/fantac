      ...
      <div ref={sectionRef} className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          >
            ...
            <h2 className="font-[family-name:var(--font-playfair)] text-4xl lg:text-5xl text-espresso mb-6 leading-tight">
              Crafted by Hand,
              <br />
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-8 py-12 border-t border-b border-warm-200 mb-16"
        >
          {stats.map((stat, i) => (
            <motion.div
              key={stat.label}
            ...
            >
              <span className="font-[family-name:var(--font-playfair)] text-4xl lg:text-5xl text-espresso block">
                {stat.number}
              </span>
              <span className="text-charcoal-500 text-xs tracking-[0.2em] uppercase mt-2 block">
                {stat.label}
              </span>
            </motion.div>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {values.map((value, i) => (
            <motion.div
              ...
              className="group"
            >
              <div className="w-8 h-[1px] bg-gold mb-5 group-hover:w-16 transition-all duration-500" />
              <h3 className="font-[family-name:var(--font-playfair)] text-xl text-espresso mb-3">
                {value.title}
              </h3>
